...
export default class ViewSubmittedLeaveApplications extends Component {
  ...
  componentDidMount = () => {
      axios.get("http://192.168.200.200:8080/backendapitest/employee/"+this.props.location.employeeId+"/leave/"+this.props.location.leaveId+"")
      .then(
          res => {
              this.setState(
                  {
...
render()
{
  ...
  <b><p>NO OF DAYS</p></b>
    ...
    <Grid container justify="space-around">
    <NavLink to={{pathname:'/hr/LeaveApplicationsList',
